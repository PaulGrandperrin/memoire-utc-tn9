...
---------- Message transféré ----------
De : "Laurent Séguin" <l.seguin@systematic-paris-region.org>
Date : 22 oct. 2011 15:36
Objet : Retour projet STERN
À : "Kevin Maziere" <kevin.maziere@alterway.fr>, "Véronique Torner - Alterway" <veronique.torner@alterway.fr>, "Philippe Montarges - Alterway" <philippe.montarges@alterway.fr>
Cc : "Stéfane Fermigier - PDT GT LL/Nuxeo" <sf@nuxeo.com>, "Roberto di Cosmo - VP GT LL/Paris7" <roberto@dicosmo.org>, "CARRE, PHILIPPE (PHILIPPE)" <philippe.carre@alcatel-lucent.com>, "Emmanuel Chailloux" <Emmanuel.Chailloux@lip6.fr>

[en copie, les présidents et vice-présidents du Copil et du Coproj]

Bonjour,

Les comités de projets et de pilotage vous remercient d'avoir pris le temps de présenter votre projet et de le soumettre à labellisation par le groupe thématique logiciel libre.

Votre projet a suscité un fort enthousiasme de la part des membres des Coproj et Copil et l'ont trouvé extrêmement pertinent et cohérent au vu de l'activité d'Alter Way hosting. A ce titre, plusieurs membres des deux instances vont activer leurs réseaux afin de vous aider à trouver (si possible avant mercredi) les chercheurs les plus pertinents, disponibles et intéressés par ce projet pour vous accompagner.
Les pistes activées sont : l'INRIA, le LIP6, PPS, l'IRISA

Je reste bien évidement à votre disposition pour toute question.
--
Laurent Séguin,
Chef de projet du Groupe Thématique Logiciel Libre
Tél. : 01 69 81 65 81 / Mob.: 06 47 96 11 92 / Fax : 01 69 41 69 19
\end{lstlisting}
