...
Cet solution utilise comme logiciels l'hyperviseur de virtualisation \textbf{Xen}\index{Xen} et le gestionnaire de Cloud \textbf{OpenNebula} et des
...
\begin{description}
	\item[OpenStack] \index{OpenStack} est un logiciel \emph{open source} créée par Rackspace et la NASA. Plus de 120 compagnies ont joint le projet dont Citrix System, Dell, AMD, Intel,
